// Simple HTTP MCP Server Implementation for Claude Desktop
// Testing simplified approach without SSE streaming
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // MCP JSON-RPC endpoint at /sse for compatibility
